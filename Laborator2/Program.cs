...
namespace DicaI_temaCLI { 
    class SimpleWindow3D : GameWindow
    {
        ...
        {
            VSync = VSyncMode.On;
            Mouse.SetPosition(Width / 2, Height / 2); // Center mouse
            lastMouseX = Width / 2;
            lastMouseY = Height / 2;
        }
        ...
        protected override void OnUpdateFrame(FrameEventArgs e)
        {
            ...
            if (mouse[MouseButton.Left])
            {
                ...
                // Ajustează unghiurile de rotație
                angleY += deltaX * rotationSpeed; // Rotează în jurul axei Y
                angleX -= deltaY * rotationSpeed; // Rotează în jurul axei X
            ...
            {
                // Resetează ultima poziție a mouse-ului când nu este apăsat
                lastMouseX = Width / 2;
                lastMouseY = Height / 2;
            }
        }
        ...
        protected override void OnRenderFrame(FrameEventArgs e)
        {
            ...
            GL.Rotate(angleX, 1.0f, 0.0f, 0.0f); // Rotează în jurul axei X
            GL.Rotate(angleY, 0.0f, 1.0f, 0.0f); // Rotează în jurul axei Y
